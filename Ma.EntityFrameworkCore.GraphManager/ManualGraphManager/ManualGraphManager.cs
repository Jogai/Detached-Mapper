...
using Ma.EntityFrameworkCore.GraphManager.ManualGraphManager.Helpers;
using Ma.EntityFrameworkCore.GraphManager.ManualGraphManager.Abstract;
using Ma.EntityFrameworkCore.GraphManager.ManualGraphManager.Helpers.Abstract;
using Ma.EntityFrameworkCore.GraphManager.AutoGraphManager.Helpers;
using Microsoft.EntityFrameworkCore;

namespace Ma.EntityFrameworkCore.GraphManager.ManualGraphManager
{
    /// <summary>
